 ...
 * footer.js
 *
 * Dynamically renders the footer section of the application.
 * The footer includes:
 * - Hospital logo
...
function renderFooter() {
    ...
    // Insert footer HTML content dynamically
    footer.innerHTML = `
        ...
        <footer class="footer">
            ...
            <div class="footer-container">
                ...
                <div class="footer-logo">
                    ...
                    <p>
                        © Copyright 2025. All Rights Reserved by Hospital CMS.
                    </p>
...
/*
 * Call renderFooter to populate the footer
